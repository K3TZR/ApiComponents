...
extension Radio {    
  ...
  public func staticNetParamsSet(callback: ReplyHandler? = nil) {
    send("radio static_net_params" + " " + StaticNetToken.ip.rawValue + "=\(staticIp) " + StaticNetToken.gateway.rawValue + "=\(staticGateway) " + StaticNetToken.netmask.rawValue + "=\(staticNetmask)")
  }
