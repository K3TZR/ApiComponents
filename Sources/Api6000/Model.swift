...
public class Model: ObservableObject, Equatable {
  ...
  public func setAmplifiers(_ amplifiers: IdentifiedArrayOf<Amplifier>) {
    self.amplifiers = amplifiers
  }
  public func setAtu(_ atu: Atu) {
    self.atu = atu
  }
  public func setGps(_ gps: Gps) {
    self.gps = gps
  }
  public func setInterlock(_ interlock: Interlock) {
    self.interlock = interlock
  }
  public func setTnfs(_ tnfs: IdentifiedArrayOf<Tnf>) {
    self.tnfs = tnfs
  }
  public func setTransmit(_ transmit: Transmit) {
    self.transmit = transmit
  }
  public func setWaterfalls(_ waterfalls: IdentifiedArrayOf<Waterfall>) {
    self.waterfalls = waterfalls
  }
  public func setPanadapters(_ panadapters: IdentifiedArrayOf<Panadapter>) {
    self.panadapters = panadapters
  }
  public func setWan(_ wan: Wan) {
    self.wan = wan
  }
