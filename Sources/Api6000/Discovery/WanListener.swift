...
public final class WanListener: NSObject, ObservableObject {
  ...
  public init(timeout: Double = kTimeout) {
    ...
    log("Wan Listener: TCP Socket initialized", .debug, #function, #file, #line)
  }
  ...
  public func sendWanConnectMessage(for serial: String, holePunchPort: Int) {
    log("Wan Listener: SmartLink connect sent to serial \(serial)", .debug, #function, #file, #line)
  ...
  public func sendWanDisconnectMessage(for serial: String) {
    log("Wan Listener: SmartLink disconnect sent to serial \(serial)", .debug, #function, #file, #line)
  ...
  public func sendWanDisconnectClientMessage(for serial: String, handle: Handle) {
    log("Wan Listener: SmartLink disconnect sent to serial \(serial), handle \(handle.hex)", .debug, #function, #file, #line)
    // send a command to SmartLink to request disconnection from the specified Radio
  ...
  public func sendSmartlinkTest(_ serial: String) {
    log("Wan Listener: smartLink test initiated to serial number, \(serial)", .debug, #function, #file, #line)
  ...
  private func startPinging() {
    ...
    log("Wan Listener: started pinging smartlink server", .debug, #function, #file, #line)
...
extension WanListener: GCDAsyncSocketDelegate {
  ...
  public func socketDidSecure(_ sock: GCDAsyncSocket) {
    ...
    // start reading
    log("Wan Listener: is listening", .debug, #function, #file, #line)
